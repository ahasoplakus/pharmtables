...
#' @importFrom tern analyze_num_patients
#' @importFrom tern append_varlabels
#' @importFrom tern count_occurrences
#' @importFrom tern count_occurrences_by_grade
