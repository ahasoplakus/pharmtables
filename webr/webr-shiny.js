import('https://webr.r-wasm.org/latest/webr.mjs').then(async ({ WebR }) => {
  ...
  const appFiles = ['app/app.R','app/DESCRIPTION','app/inst/app/www/custom.css','app/inst/app/www/favicon.ico','app/inst/app/www/logo.png','app/inst/extdata/adae.RDS','app/inst/extdata/adcm.RDS','app/inst/extdata/adeg.RDS','app/inst/extdata/adlb.RDS','app/inst/extdata/admh.RDS','app/inst/extdata/adsl.RDS','app/inst/extdata/advs.RDS','app/inst/figures/logo.png','app/inst/figures/table.png','app/inst/golem-config.yml','app/inst/WORDLIST','app/R/adae_utils.R','app/R/app_config.R','app/R/app_server.R','app/R/app_ui.R','app/R/build_shift_table.R','app/R/clinTables-package.R','app/R/data.R','app/R/global.R','app/R/mod_adae_global.R','app/R/mod_adae_sev_tox.R','app/R/mod_adae_summary.R','app/R/mod_adsl_display.R','app/R/mod_adsl_filters.R','app/R/mod_adxx_bodsys.R','app/R/mod_adxx_param.R','app/R/mod_bds_analysis.R','app/R/mod_bds_shift.R','app/R/mod_data_preview.R','app/R/mod_data_read.R','app/R/mod_dt_table.R','app/R/mod_filter_reactivity.R','app/R/mod_process_adsl.R','app/R/mod_setup_filters.R','app/R/run_app.R','app/R/ui_utils.R','app/R/utils.R','app/R/utils_helpers.R']; // DON'T REMOVE
  ...
  await webR.evalRVoid(`
    webr::install(c("bs4Dash","dplyr","formatters","golem","purrr","rlang","rtables","shiny","shinyjs","shinyWidgets","stringr","tern"), repos="https://webr-cran.rinterface.com/")
  `);
